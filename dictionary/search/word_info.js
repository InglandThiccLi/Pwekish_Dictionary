...
function generateWordDetailHtml(word) {
    ...
    const bentolPwekTable = generateBentolTable(word[8], 'BentolPwék', 'Corresponding Romanization');
    
    // Generate Middle Pwekish table
    var middlePwekishTableDiv = '';
    if (word[9] != "\\")  {
        const middlePwekishTable = generateBentolTable(word[9], 'Middle Pwekish', 'Corresponding Romanization');
